...
<html lang="en" dir="ltr">
  ...
  <link rel="stylesheet" href="../css/oes-question-page.css">
  </head>
  <body>
            ...
            <div class="content-frame1">
              ...
              <div class="question-frame3">
                ...
                <div class="question-frame4">
                  ...
                  <input type="button" class="btn btn-outline-danger" name="save" value="Reset Question" id="rev">
                  <input type="button" class="btn btn-outline-info" name="next" value="Next-->" id="nex">
                </div>
                <!-- End bottom buttons -->
              </div>
            </div>
            ...
            <div class="content-frame2">
              ...
              <div class="question-frame5">
                ...
                <div class="question-submit">
                  <button class="btn btn-danger text center"><i class="material-icons">lock</i>Finish Exam</button>
                </div>
              </div>
            </div>
          </div>
