...
<body>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-primary" type="button">update User</button>
                    </td>
                  </tr>
                  <tr>
                    <td>
  ...
  <script type="text/javascript">
    function showImage(){
      console.log("We are in Show Image function");
      var showimg = document.getElementById('image');
      var getimg = document.getElementById('read-file');
      showimg.innerHTML=" "+getimg.value;
    }
