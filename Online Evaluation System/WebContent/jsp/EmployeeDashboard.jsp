      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          <li class="nav-item active  ">
            <a class="nav-link" href="../html/EmployeeDashboard.html">
              <i class="material-icons">dashboard</i>
              <p> Employee Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../html/User.html">
              <i class="material-icons">person</i>
              <p>User Profile</p>
            </a>
          </li>
          <li>
          	<a class="nav-link" href="../html/OesQuestionPage.html">
          ...
          <li>
            <a class="nav-link" href="../html/Notifications.html">
