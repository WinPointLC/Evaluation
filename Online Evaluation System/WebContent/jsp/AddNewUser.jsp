...
<html lang="en">
  ...
  <body>
      ...
      <div class="add-new-user-content" id="add-new-user-content">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" id="modal-btn">Add a new user</button>
        <!-- <button type="button" class="btn btn-primary" onload="CallModal();" id="modal-btn">Add a new user</button> -->
          ...
          <script type="text/javascript">
            ...
            // modalbtn.setAttribute('data-target',".bd-example-modal-lg");
            // }
          </script>
          <!--   Core JS Files   -->
